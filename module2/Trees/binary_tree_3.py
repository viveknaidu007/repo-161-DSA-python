# This is alternative for node with "two child"
class BinaryTreeNode:
    ...
    def delete(self, val):
        if val < self.data:
            ...
            # for "two child" we will choose maximum value from the left-subtree and replace it with current node
...
if __name__ == '__main__':
    ...
    numbers = [17, 4, 1, 20, 9, 23, 18, 13, 19, 34]
